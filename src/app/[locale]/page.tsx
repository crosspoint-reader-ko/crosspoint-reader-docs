...
import { BootScreenShowcase } from "@/components/boot-screen-showcase";
...
type FeatureKey = "epub" | "flasher" | "wifi" | "sync" | "sensor" | "smart";
...
export default async function Home({
  ...
  const [contributors, latestRelease, t] = await Promise.all([
    getContributors(),
    getLatestRelease(),
  ...
  const publishedDate = latestRelease?.published_at
    ? new Date(latestRelease.published_at).toLocaleDateString(dateLocale, {
        year: "numeric",
        month: "long",
        day: "numeric",
      })
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="text-center lg:text-left">
                <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                  <span className="text-blue-600">{t("hero.brandPrefix")}</span>{" "}
                  {t("hero.brandSuffix")}
                </h1>
                <div className="mt-4 flex flex-col sm:flex-row items-center lg:items-start gap-3">
                  <p className="text-xl text-gray-600">
                    {t("hero.firmwareLabel")}{" "}
                    <span className="inline-flex items-center rounded-md bg-blue-100 px-2 py-1 text-sm font-medium text-blue-700">
                      v{CROSSPOINT_VERSION}
                    </span>
                  </p>
                  {publishedDate && (
                    <span className="text-sm text-gray-400">
                      {publishedDate} {t("hero.publishedSuffix")}
                    </span>
                  )}
                </div>
                <div className="mt-2">
            ...
            <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-3">
              <div className="text-center">
                ...
                <h3 className="mt-6 text-xl font-semibold text-white">
                  {t("quickStart.steps.usb.title")}
                </h3>
                <p className="mt-2 text-gray-400">
                  {t("quickStart.steps.usb.description")}
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="mt-6 text-xl font-semibold text-white">
                  {t("quickStart.steps.flasher.title")}
                </h3>
                <p className="mt-2 text-gray-400">
                  {t("quickStart.steps.flasher.description")}
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="mt-6 text-xl font-semibold text-white">
                  {t("quickStart.steps.complete.title")}
                </h3>
                <p className="mt-2 text-gray-400">
                  {t("quickStart.steps.complete.description")}
                </p>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-lg">
                ...
                <div className="flex">
                  ...
                  <div className="flex-1 p-4">
                    <div className="flex items-center gap-2 text-sm text-gray-500 mb-2">
                      ...
                      <span>{t("credits.repoSource")}</span>
                    </div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-100">
                <p className="text-sm text-gray-500 text-center">
                  ...
                  >
                    {t("credits.inspirationLink")}
                  </a>
                  {t("credits.inspirationSuffix")}
                </p>
              </div>
                ...
                <div className="flex flex-wrap justify-center gap-2">
                  {contributors.map((contributor) => (
                    <a
                      ...
                      title={t("credits.contributorTitle", {
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    >
                      ...
                      {t("credits.sponsorKofi")}
                    </a>
                    <a
                      href="https://buymeacoffee.com/eunchurn"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 rounded-full bg-[#FFDD00] px-5 py-2.5 text-sm font-semibold text-gray-900 hover:bg-[#e5c700] transition-colors shadow-md"
                    >
                      <svg
                        className="h-5 w-5"
                        viewBox="0 0 24 24"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <h3 className="mt-4 text-lg font-semibold text-gray-900 group-hover:text-blue-600">
                  {t("links.webFlasher.title")}
                </h3>
                <p className="mt-2 text-sm text-gray-500">
                  {t("links.webFlasher.description")}
                </p>
                <span className="mt-3 inline-flex items-center text-sm text-blue-600">
                  {t("links.webFlasher.domain")}
                  <svg
              ...
              >
                ...
                <h3 className="mt-4 text-lg font-semibold text-gray-900 group-hover:text-orange-600">
                  {t("links.x4Converter.title")}
                </h3>
                <p className="mt-2 text-sm text-gray-500">
                  {t("links.x4Converter.description")}
                </p>
                <span className="mt-3 inline-flex items-center text-sm text-orange-600">
                  {t("links.x4Converter.domain")}
                  <svg
                    className="ml-1 h-4 w-4"
                    fill="none"
                    viewBox="0 0 24 24"
              ...
              >
                ...
                <h3 className="mt-4 text-lg font-semibold text-gray-900 group-hover:text-green-600">
                  {t("links.epub2xtc.title")}
                </h3>
                <p className="mt-2 text-sm text-gray-500">
                  {t("links.epub2xtc.description")}
                </p>
                <span className="mt-3 inline-flex items-center text-sm text-green-600">
                  {t("links.epub2xtc.domain")}
                  <svg
                    className="ml-1 h-4 w-4"
                    fill="none"
                    viewBox="0 0 24 24"
              ...
              >
                ...
                <h3 className="mt-4 text-lg font-semibold text-gray-900 group-hover:text-amber-600">
                  {t("links.calibreWorkflow.title")}
                </h3>
                <p className="mt-2 text-sm text-gray-500">
                  {t("links.calibreWorkflow.description")}
                </p>
                <span className="mt-3 inline-flex items-center text-sm text-amber-600">
                  {t("links.calibreWorkflow.domain")}
                  <svg
                    className="ml-1 h-4 w-4"
                    fill="none"
                    viewBox="0 0 24 24"
              ...
              >
                ...
                <h3 className="mt-4 text-lg font-semibold text-gray-900 group-hover:text-amber-600">
                  {t("links.calibrePlugins.title")}
                </h3>
                <p className="mt-2 text-sm text-gray-500">
                  {t("links.calibrePlugins.description")}
                </p>
                <span className="mt-3 inline-flex items-center text-sm text-amber-600">
                  {t("links.calibrePlugins.domain")}
                  <svg
                    className="ml-1 h-4 w-4"
                    fill="none"
                    viewBox="0 0 24 24"
              ...
              >
                ...
                <h3 className="mt-4 text-lg font-semibold text-gray-900 group-hover:text-purple-600">
                  {t("links.readmeClub.title")}
                </h3>
                <p className="mt-2 text-sm text-gray-500">
                  {t("links.readmeClub.description")}
                </p>
                <span className="mt-3 inline-flex items-center text-sm text-purple-600">
                  {t("links.readmeClub.domain")}
                  <svg
                    className="ml-1 h-4 w-4"
                    fill="none"
                    viewBox="0 0 24 24"
              ...
              >
                ...
                <h3 className="mt-4 text-lg font-semibold text-gray-900 group-hover:text-pink-600">
                  {t("links.wallpaperConverter.title")}
                </h3>
                <p className="mt-2 text-sm text-gray-500">
                  {t("links.wallpaperConverter.description")}
                </p>
                <span className="mt-3 inline-flex items-center text-sm text-pink-600">
                  {t("links.wallpaperConverter.domain")}
                  <svg
                    className="ml-1 h-4 w-4"
                    fill="none"
                    viewBox="0 0 24 24"
