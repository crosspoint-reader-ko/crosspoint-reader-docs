  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="text-sm font-medium text-gray-600 hover:text-pink-500 transition-colors flex items-center gap-1 whitespace-nowrap"
        aria-label={t("button")}
      >
        ...
        <svg
          className={`hidden xl:block h-4 w-4 transition-transform ${isOpen ? "rotate-180" : ""}`}
          fill="none"
          viewBox="0 0 24 24"
          strokeWidth="2"
          stroke="currentColor"
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <span className="hidden sm:inline nav:hidden xl:inline">{labels[currentLocale]}</span>
        <svg
    ...
    <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200">
      <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          {/* Desktop navigation */}
          <div className="hidden nav:flex nav:items-center nav:gap-x-3 xl:gap-x-6">
            {navigation.map((item) => {
              if (item.children) {
                return (
                  <DropdownMenu
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-sm font-medium text-gray-600 hover:text-blue-600 transition-colors flex items-center gap-1 whitespace-nowrap"
            >
